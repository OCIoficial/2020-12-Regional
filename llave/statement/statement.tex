...
Cada diente puede ser limado de forma independiente, reduciendo su altura; sin embargo, para preservar
...
La primera línea de la entrada contiene dos enteros $n$ y $m$ ($0 \leq m \leq n, 0 < n \leq 100$), correspondientes
respectivamente a la cantidad de dientes en la llave y al valor máximo de dientes
que es posible limar.
La segunda línea contiene $n$ enteros positivos y menores o iguales que 10,
...
La salida debe contener una sola línea con un \verb|si| en caso de ser posible
limar la llave de forma que se logre abrir la cerradura, y \verb|no| en caso contrario.
